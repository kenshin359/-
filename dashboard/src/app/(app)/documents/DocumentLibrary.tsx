...
import { DOC_CATEGORIES, DOC_DEPARTMENTS, DOC_KIND_LABEL, type DocKind, type DocumentItem } from '@/lib/documents';
import { createDocumentAction, deleteDocumentAction, updateDocumentAction, type ActionResult } from './actions';
...
function DocForm({ doc, onDone }: { doc: DocumentItem | null; onDone: (r: ActionResult) => void }) {
