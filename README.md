...
| [`task-calendar/`](./task-calendar/) | **業務タスク カレンダー可視化ツール**：チームの業務タスクを、カレンダーとタスク選択ボタンでその場で可視化。負荷の偏り・遅延・締切集中を一目で把握。`index.html` を開くだけ。kintone連携・Chatwork通知にも対応（[手順](./daily-report-system/docs/task-calendar-setup.md)）。 |
